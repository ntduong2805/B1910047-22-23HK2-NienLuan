                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="content">
                            <div class="toolbar">
                                <a href="
                                {{ route('admin.roomtype.image.create', $roomtype->id)}}
                                    " rel="tooltip" title="Add New Image"
                                                ...
                                                <td>
                                                    <div class="table-icons">
                                                        ...
                                                        <a rel="tooltip" title="Edit"
                                                           ...
                                                           href="
                                                           {{ route('admin.roomtype.image.edit', ['id1' => $roomtype->id, 'id2' => $image->id]) }}
                                                           ">
                                                        ...
                                                        <div class="collapse">
                                                            ...
                                                            <form action="
                                                                {{ route('admin.roomtype.image.destroy', ['id1' => $roomtype->id, 'id2' => $image->id]) }}" id="delete-image" method="POST">
                                                                @method('delete')
                                                                @csrf
    ...
    <script type="text/javascript">
        ...
        var delete_button = function(){
            swal({  title: "Are you sure?",
                text: "After you delete the image.",
                type: "warning",
