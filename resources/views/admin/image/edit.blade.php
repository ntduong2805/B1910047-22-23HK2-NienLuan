...
@section('title', 'Room Type | Image - Edit')
                ...
                <div class="col-md-10 col-md-offset-1">
                    <div class="card">
                        ...
                        <div class="content">
                            ...
                            <form action="{{ route('admin.roomtype.image.update', ['id1' => $roomtype->id, 'id2' => $image->id]) }}" enctype="multipart/form-data" method="POST">
                                @method('put')
                                @csrf
                            
                            <div class="row">
                                <div class="col-md-12" align="center">
                                    <img height="250px" width="600px" src="{{'/storage/roomtypes/'.$image->name}}"/>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
