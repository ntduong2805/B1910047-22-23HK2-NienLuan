        ...
        <div class="db-cent-table db-com-table">
            ...
            <table class="bordered responsive-table">
                ...
                <tr>
                    ...
                    <td>{{ $room_booking->room_cost }} VNĐ</td>
                    <td>
                    ...
                    <td>@if($room_booking->status == "checked_out" && $room_booking->payment == true)
                        <a href="
                        {{ route('dashboard.review', $room_booking->id) }}
                        {{-- {{url('dashboard/room/booking/'.$room_booking->id.'/review')}} --}}
                        "><span class="label label-primary">Review</span></a>
                        @endif
                        @if($room_booking->status !== "cancelled")
                            <a href="
                            {{ route('dashboard.roomcancel', $room_booking->id) }}

                            {{-- {{url('dashboard/room/booking/'.$room_booking->id.'/cancel')}} --}}
                            "><span class="label label-danger">Cancel</span></a>
                        @endif
                    </td>
